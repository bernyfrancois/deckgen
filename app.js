...
class Player {
    ...
    describe(){
        ...
        messageZone.textContent = `Pour une base de ${this.symbols.length} symboles vous avez ${this.deck.length} cartes valides possibile, ouvrez la console pour voir la liste des cartes`
    }
};
